...
## Data Visualization 
```{r mutation_vis}
dir.create(here('mutant_gene_heatmaps','mutation_heatmaps'),showWarnings = F)
for (kinase in unique(kinase_mutation_freq$gene_id)) {
  ...
  ggsave(here('mutant_gene_heatmaps','mutation_heatmaps',paste0(kinase,'.svg')),height=2.75)
}
```

```{r CNV_vis}
dir.create(here('mutant_gene_heatmaps','CNV_heatmaps'),showWarnings = F)
for (kinase in unique(kinase_CNV_freq$gene_id)) {
  ...
  ggsave(here('mutant_gene_heatmaps','CNV_heatmaps',paste0(kinase,'.svg')),height=2.75)
}
```
